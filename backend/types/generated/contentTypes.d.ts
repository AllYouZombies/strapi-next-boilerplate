...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    telegram_link: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMainPageContentMainPageContent
  ...
  attributes: {
    about_us: Schema.Attribute.Text &
...
export interface ApiSeoSettingSeoSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global SEO configuration and metadata';
